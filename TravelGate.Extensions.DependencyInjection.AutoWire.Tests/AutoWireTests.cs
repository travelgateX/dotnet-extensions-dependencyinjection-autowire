...
using TravelGate.Extensions.DependencyInjection.AutoWire.Tests.Dummy.Domain;
using TravelGate.Extensions.DependencyInjection.AutoWire.Tests.Dummy.Options;
using TravelGate.Extensions.DependencyInjection.AutoWire.Tests.Dummy.Others;
using TravelGate.Extensions.DependencyInjection.AutoWire.Tests.Dummy.Services;
...
namespace TravelGate.Extensions.DependencyInjection.AutoWire.Tests
{
    public class AutoWireTests : BaseTest
    {
        ...
        public void AutoWireRegistersGenericClasses()
        {
            ...
            Assert.StartsWith(
                "Microsoft.Extensions.Options.IOptionsMonitor`1[[TravelGate.Extensions.DependencyInjection.AutoWire.Tests.Dummy.Options.ConfigOptions",
        ...
        public void AutoWiredConfiguredOptionsDoNotBreakWhenChangingConfiguration()
        {
            ...
            sc.AutoWire(config, autoWireOptions =>
            {
                ...
                autoWireOptions.ReloadConfigurationInterval = TimeSpan.FromSeconds(1);
                autoWireOptions.MakeOptionsMonitorUpdateSafe = true;
                autoWireOptions.NotifyExceptionAction = (o, type, ex) => { Assert.NotNull(o); };
            });
